...
#1 julia --project abcdh.jl -n 75 -d 2.5,1,25 -c 1.5,10,45 -x 0.5 -q 0.0,0.4,0.3,0.2,0.1 -w :linear -s 1234 -o result --stats
#2 julia --project abcdh.jl -n 75 -d 2.5,1,25 -c 1.5,10,45 -x 0.5 -q 0.0,0.4,0.3,0.2,0.1 -w :strict -s 1234 -o result --stats
#3 julia --project abcdh.jl -n 75 -d 2.5,1,25 -c 1.5,10,45 -x 0.33 -q 0.0,0.4,0.3,0.2,0.1 -w :linear -s 1234 -o result --stats
#4 julia --project abcdh.jl -n 75 -d 2.5,1,25 -c 1.5,10,45 -x 0.25 -q 0.0,0.4,0.3,0.2,0.1 -w :linear -s 1234 -o result --stats
